...
const EditPost = (props) => {
    ...
    const [item, setItem] = useState({ title: props.title, description: props.description, tag: props.tag })
    ...
    return (
            <form  >
                ...
                <div className="form-group">
                    <label for="exampleFormControlTextarea1" style={{ "color": "black" }}>Decription*</label>
                ...
                <div className="form-group my-2">
                    <div className="mb-3">
                        <label for="formFile" className="form-label" style={{ "color": "black" }}>Choose Image*</label>
